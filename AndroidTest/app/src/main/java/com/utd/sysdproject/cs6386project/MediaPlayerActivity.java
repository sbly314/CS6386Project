...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setTitle(MediaName);
        // set a message for the progress bar
        progressDialog.setMessage("Loading...");
        // set the progress bar not cancellable on users' touch
...
//            String URL = "wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mov";
        ...
        // also set an setOnPreparedListener in order to know when the video file is ready
        vidView.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
            public void onPrepared(MediaPlayer mediaPlayer) {
                // close progress bar and play the video
                progressDialog.dismiss();
                // if we have a position on savedInstanceState, the video playback should start there
